# import array
# arr = array.array("i",[1,2,3,4,5,6,7])  #memory effeciency to deal with databases
# print(arr)  #type data:to ensure that all elements in the array of same typeprint(arr)
####Array traversal####
# import array
